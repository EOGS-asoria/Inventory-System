...
export default function DepartmentCreateSection() {
        ...
        <>
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Department Section</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the department on the site.
                    </p>
                </div>
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <div className='flex gap-2'>
                                            <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
                                                <FolderPlusIcon aria-hidden="true" className="h-6 w-6 text-blue-600" />
                                            </div>
