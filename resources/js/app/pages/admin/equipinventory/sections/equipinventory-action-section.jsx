...
export default function EquipinventoryActionSection() {
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md border border-indigo-300 px-3 py-2 text-sm font-semibold text-gray-900 bg-transparent shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-indigo-100 hover:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    Options
