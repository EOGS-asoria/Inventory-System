...
import { FolderPlusIcon, InformationCircleIcon, WrenchIcon } from '@heroicons/react/24/outline'
import Input from '@/app/_components/input'
import Select from '@/app/_components/select'

export default function EquipinventoryCreateSection() {
        ...
        <>
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Equipment Inventory Section</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the equipment inventory on the site.
                    </p>
                </div>
