...
import { ExclamationTriangleIcon, FolderPlusIcon, WrenchIcon } from '@heroicons/react/24/outline'

export default function EquiptypeCreateSection() {
        ...
        <>
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Equipment Type Section</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the equipment type on the site.
                    </p>
                </div>
